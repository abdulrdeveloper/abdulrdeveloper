  ...
  return (
    <div className="card">
      <div className="avatar-wrap">
        <img src="abdul.jpeg" alt="Abdul Rahman" className="avatar-image" />
      </div>
      ...
      <p className="bio">
        Full-stack developer focused on building clean web apps. I enjoy
        collaborating with other devs and shipping things that solve real
        problems.
      </p>
      ...
      <div className="socials">
        ...
        <a
          href="mailto:hire@abdulrdeveloper.me"
          className="social-btn"
          title="Email"
        >
